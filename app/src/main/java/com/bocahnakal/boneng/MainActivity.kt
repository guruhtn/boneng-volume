//Package adalah sebuah sarana untuk mengelompokkan atau mengorganisasikan kelas dan interface yang sama
// atau sekelompok menjadi satu unit tunggal dalam library.
// Package mempengaruhi mekanisme hak akses ke kelas didalamnya.
package com.bocahnakal.boneng
//Fungsi import android.os.Budle untuk membaca Data dengan  tipe berbentuk String,
// angka (integer, float, double), ArrayList, boolean, array, character, dan sebagainya.
import android.os.Bundle
//Fungsi import android.support.v7.app.AppCompatActivity untuk mengimplementasikan ActionBar/Toolbar dan Material
// Design pada aplikasi yang kita buat di Android Studio.
import android.support.v7.app.AppCompatActivity
//Fungsi import android.view.View untuk untuk Menampilkan data-data pada sebuah Gadget
// Seperti Menu-menu yang terdapat pada Aplikasi Android tersebut.
import android.view.View
//Fungsi import android.widget.... untuk memanggil dan menampilkan sebuah widget
// pada program Android sehingga dapat diklik atau di link ke widget yang lainnya.
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        if (v.id == R.id.btn_calculate){
            ...
            //jika input kosong maka akan muncul pernyataan error "Harus di Isi".
            if (inputLength.isEmpty()){
                isEmptyFields = true
                editLength.error = "Harus di Isi"
            }

            if (inputWidth.isEmpty()){
                isEmptyFields = true
                editWidth.error = "Harus di Isi"
            }

            if (inputHeight.isEmpty()){
                isEmptyFields = true
                editHeight.error = "Harus di Isi"
            }
    ...
    //onSaveInstanceState digunakan untuk situasi dimana Activity dapat dibuat ulang dengan menyimpan
    // dan mengembalikan state Actibvity sebelumnya, misalnya saat screen rotation (perubahan orientasi layar).
